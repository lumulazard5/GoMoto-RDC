        ...
        {activeTab === "profile" && (
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-xl space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Date de Naissance (Lecture uniquement)</label>
                <div className="relative">
                  <input
                    type="text"
                    value={profile.birthDate || "12-05-1994"}
                    readOnly
                    className="w-full bg-slate-950 border border-slate-850 text-slate-455 rounded-xl pl-4 pr-10 py-2.5 text-xs outline-none cursor-not-allowed select-none font-bold font-mono"
                  />
                  <Lock className="w-3.5 h-3.5 text-slate-600 absolute right-3.5 top-3.5" />
                </div>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block">Lieu de Naissance (Pays, Province, Ville)</label>
                <div className="relative">
                  <input
                    type="text"
                    value={`${profile.birthCity || "Lubumbashi"}, ${profile.birthProvince || "Haut-Katanga"}, ${profile.birthCountry || "République Démocratique du Congo"}`}
                    readOnly
                    className="w-full bg-slate-950 border border-slate-850 text-slate-455 rounded-xl pl-4 pr-10 py-2.5 text-xs outline-none cursor-not-allowed select-none font-bold"
                  />
                  <Lock className="w-3.5 h-3.5 text-slate-600 absolute right-3.5 top-3.5" />
                </div>
              </div>
